...
**TTS Sidecar 0.9.0** se distribuye bajo la licencia
...
- **Código fuente (tarball del tag):**
  <https://github.com/CristianRojas-SoftwareEngineer/TTS-Sidecar/archive/refs/tags/v0.9.0.tar.gz>
- **Release v0.9.0 (artefactos y notas):**
  <https://github.com/CristianRojas-SoftwareEngineer/TTS-Sidecar/releases/tag/v0.9.0>
